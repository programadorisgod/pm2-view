	...
	<div class="w-full max-w-sm relative z-10">
		...
		<div class="card-base rounded-xl p-xl">
			<div class="text-center mb-lg">
				<h1 class="text-h2 font-semibold mb-xs" style="color: var(--text-primary);">Create Account</h1>
				<p class="text-body-sm" style="color: var(--text-secondary);">Sign up for your dashboard</p>
			</div>
			...
			<form onsubmit={handleSubmit} class="space-y-md">
				...
				<div>
					<label for="name" class="block text-caption font-medium mb-xs" style="color: var(--text-secondary);">Name</label>
					<input
						id="name"
						type="text"
						bind:value={name}
